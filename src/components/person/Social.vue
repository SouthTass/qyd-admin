  ...
  <el-form ref="pSystem" 
    ...
    <div class="form-item">
      ...
      <div class="container">
        ...
        <el-form-item label="是否退休" prop="is_rest">
        ...
        <el-form-item label="说明" prop="social_desc" v-if="$root.user.social.is_rest == '是'">
          <el-select v-model="$root.user.social.social_desc" class="from-width-l1">
            <el-option v-for="item in $root.user.item6" 
              :key="item" :label="item" :value="item"></el-option>
          </el-select>
        </el-form-item>
      </div>
