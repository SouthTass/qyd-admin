  ...
  <div>
    <div class="crumbs">
      <el-breadcrumb separator="/">
        ...
        <el-breadcrumb-item>员工培训需求</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="container">
      ...
      <el-table :data="tableData" border class="table" header-cell-class-name="table-header">
        ...
        <el-table-column label="培训职位" prop="recruit_position" width="180"></el-table-column>
        <el-table-column label="培训等级" prop="recruit_level" width="180"></el-table-column>
        <el-table-column label="培训内容" prop="recruit_desc"></el-table-column>
    ...
    <ComponentsTrain ref="componentsTrain" @success="companyRecruitList"></ComponentsTrain>
  </div>
</template>
