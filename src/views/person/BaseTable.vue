  ...
  <div>
    ...
    <div class="container">
      <div class="handle-box">
        <el-input v-model="searchText" placeholder="请输入身份号或姓名" class="handle-input mr10"></el-input>
        <el-button type="primary" icon="el-icon-search" @click="censusList">检索</el-button>
